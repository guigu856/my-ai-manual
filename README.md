...
把已有的视频参考报告、拆解文档、分析笔记或聊天文字转化为一条新视频，并在本机剪映完成可完整预览的时间线。

- 只读取参考材料，不下载、抽帧或重新分析参考视频
- 三个确认点：创作方案 → 素材与 BGM → 逐镜剪辑表，确认后冻结
- 创作方案确定视频类型与核心机制、整体制作方法、视觉语言、节奏与声音方法、转场原则、素材与音乐性质、观看体验
- 逐镜表七列：时间 / 使用素材 / 画面处理 / 附加效果 / 文字 / 声音与节拍 / 衔接方式
- 只通过可见界面操作剪映，完成时间线和完整预览检查后停留预览状态，不点击最终导出
